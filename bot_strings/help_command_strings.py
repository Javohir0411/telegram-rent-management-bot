...
class HelpStrings:
    TEXT = {
        LanguageEnum.uzl.name: (
            ...
            "/add_product - Ma'lumotlar bazasiga mahsulot qo'shish.\n"
        ...
        LanguageEnum.uzk.name: (
            ...
            "/add_product - Маълумотлар базасига маҳсулот қўшиш.\n"
        ...
        LanguageEnum.rus.name: (
            ...
            "/add_product - Добавить товар в базу данных.\n"
            "/total - Посмотреть общее количество товаров.\n"
